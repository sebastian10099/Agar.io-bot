...
Updated: 2026-06-25 19:15:51 UTC
...
|---|---|---|---|
| OpenClaw / OpenClout autonomous agent | openclaw-token-optimizer/openclaw-token-optimizer | apache-2.0 | code reuse allowed through safe_code_intake with attribution/review |
| OpenClaw / OpenClout autonomous agent | AuroraKON6/xianyu-agent | unknown | concept only; no code reuse |
| OpenClaw / OpenClout autonomous agent | satawarlock-a11y/agent-memory-core | mit | code reuse allowed through safe_code_intake with attribution/review |
| OpenClaw / OpenClout autonomous agent | MABAIStrategies/agent-guardrails-v0.1 | mit | code reuse allowed through safe_code_intake with attribution/review |
| OpenClaw / OpenClout autonomous agent | yahweh12025-dev/human-ai | unknown | concept only; no code reuse |
| OpenClaw core autonomy | zeroclaw-labs/zeroclaw | apache-2.0 | code reuse allowed through safe_code_intake with attribution/review |
| OpenClaw core autonomy | beancookie/xiaoclaw | mit | code reuse allowed through safe_code_intake with attribution/review |
